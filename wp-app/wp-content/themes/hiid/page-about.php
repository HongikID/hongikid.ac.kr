...
<!--        <div id="about__welcome__logo--light" class="about__welcome__logo about__welcome__logo--light"></div>-->
    ...
    <section class="about__about container-fluid">
    ...
    <section class="about__faculty container-fluid">
        ...
        <div class="row">
            <div class="col-sm-6 about__faculty__philosophy">
            ...
            <div class="col-sm-6 about__faculty__professors">
                <?php
                    $facultySections = $data["faculties"];
                    foreach ($facultySections as $facultySection) {
                        print("<div class=\"about__faculty__professors__section\">");
                        print("<h4 class=\"about__faculty__professors__title\">${facultySection['name']}</h4>");
                        print("<div class=\"about__faculty__professors__professor__list\">");
                        foreach ($facultySection["professors"] as $professor) {
                            print("<div class=\"about__faculty__professors__professor\">");
                            print("<img class=\"about__faculty__professors__professor__image\" src=\"${professor['image_url']}\" alt=\"${professor['name']} 교수 프로필 사진\" width=\"145px\" height=\"145px\">");
                            print("<h5 class=\"about__faculty__professors__professor__name\">${professor['name']}</h5>");
                            print("</div>");
                        }
                        print("</div>");
                        print("</div>");
    ...
    <section class="about__curriculum container-fluid">
        <h2 class="about__section-title about__curriculum__title">Curriculum</h2>
        <div class="about__curriculum__main">
            <h3 class="about__curriculum__main__title accent">Class for<br>Designers</h3>

            <ul class="about__curriculum__main__nav nav nav-pills mb-3" role="tablist">
    ...
    <div class="about__cta">
        <h4>Learn More</h4>
        <a href="/exhibitions/2017">2017 Graduate Show &rsaquo;</a>
    </div>
</div>
<?php
get_footer();
